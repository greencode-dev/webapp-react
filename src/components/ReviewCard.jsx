        ...
        <Card className="glass-card mb-4 border-0 text-white">
            <Card.Body>
                <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span className="small text-neon-secondary opacity-75">
                        {renderStars(rating)}
                    </span>
                </div>
                <p
                    className="card-text text-light opacity-80 mb-0 font-italic"
                    style={{ borderLeft: '3px solid var(--primary-neon)', paddingLeft: '1rem' }}>
                    "{review.text}"
                </p>
            </Card.Body>
        </Card>
