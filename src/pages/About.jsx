    ...
    const features = [
        {
            icon: "🔍",
            title: "Scopri",
            description: "Esplora un catalogo in costante espansione con filtri avanzati e raccomandazioni personalizzate.",
        },
        {
            icon: "💬",
            title: "Condividi",
            description: "Lascia le tue recensioni, leggi le opinioni della community e confronta i punti di vista.",
        },
        {
            icon: "🏆",
            title: "Colleziona",
            description: "Crea la tua watchlist personale, tieni traccia dei film visti e scopri nuove gemme nascoste.",
        },
    ];
        ...
        <div className="about-page pb-5">
            ...
            <header className="about-hero mb-5 px-3">
                ...
                <div className="hero-content text-center about-animate">
                    <span className="about-badge mb-4 d-inline-block">🎥 La tua piattaforma cinema</span>
                    <h1 className="display-1 fw-bold mb-3">
                        <span className="text-neon-primary">Cine</span>
                        <span className="text-neon-secondary">Lab</span>
                    </h1>
                    <p className="fs-4 mb-4 text-light opacity-80" style={{ maxWidth: "600px", margin: "0 auto" }}>
            ...
            <section className="container about-animate">
                <div className="text-center mb-5">
                    ...
                    <h2 className="display-6 fw-bold text-gradient">Per iniziare la tua ricerca...</h2>
                </div>
                <Row className="g-4">
